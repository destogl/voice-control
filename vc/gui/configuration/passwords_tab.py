...
from vc.gui.configuration.text_field_button import TextFieldButton

class PasswordsTab(GenericTab):

    def __init__(self, data):
        self.data = data
        
        super(PasswordsTab, self).__init__()
        ...
        button = gtk.Button("Add password macro")
    ...
    def __create_entry_object(self, data, key):
        tf_butt = TextFieldButton(data, key)
